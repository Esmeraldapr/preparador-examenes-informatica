...
(async function iniciar() {
  ...
  // Nos interesan solo los intentos de preguntas de ESTA asignatura para las estadísticas
...
function pintarAccesos(totalExamenes, totalTrucos) {
  document.getElementById("accesos").innerHTML = `
    ...
    <a class="tarjeta" href="${enlaceAsignatura("practica.html", ASIGNATURA_ID)}">
      ...
      <div class="cuerpo"><div class="meta">Aleatorio, solo fallos o solo favoritas</div></div>
    </a>
